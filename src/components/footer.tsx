      ...
      <div className="max-w-7xl mx-auto grid grid-cols-1 md:grid-cols-4 gap-8 md:gap-16">
        ...
        <div>
          ...
          <ul className="space-y-2">
            <li>
              <Link href="/policies" className="text-[22px] text-gray-800 underline hover:no-underline transition-all duration-300">
                Policies
              </Link>
            </li>
            <li>
              <Link href="/book-a-room" className="text-[22px]  text-gray-800 underline hover:no-underline transition-all duration-300">
                Book now
              </Link>
            </li>
          </ul>
