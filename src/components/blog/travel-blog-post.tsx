...
export function TravelBlogPostComponent() {
  return (
    <section className={`container mx-auto px-4 py-16 ${cormorantGaramond.className} md:mt-[200px] h-[90vh]`}>
      <div className="flex flex-col md:flex-row gap-12">
        ...
        <div className="md:w-1/2 flex flex-col justify-center gap-12">
          ...
          <h2 className="text-5xl mb-4">When is the best time to travel to Costa Rica?</h2>
          ...
          <Link href="#" className="underline font-bold text-[25px]">
            Read More
          </Link>
        </div>
      </div>
